...
# Interfaz principal
root = tk.Tk()
root.title("Calculadora de Matrices y Probabilidades")
...
submenu.add_command(label="Matrices", command=mostrar_opciones)
submenu.add_command(label="Probabilidades", command=calcular_probabilidades)
